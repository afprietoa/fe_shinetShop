...
var Products = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("../../../build/tsc/data/products.json")];
                    case 1:
                        result = _a.sent();
    ...
    Products.prototype.displayProducts = function (cardsContainer, products) {
        printCards(cardsContainer, products);
    };
    Products.prototype.displayList = function (listContainer, category) {
        printList(listContainer, category);
    };
    Products.prototype.filterProducts = function (category, products, cardsContainer) {
        filterCards(category, products, cardsContainer);
    };
    Products.prototype.sortProducts = function (sorts, products, cardsContainer) {
